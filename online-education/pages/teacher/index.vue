        ...
        <div>
          <div class="paging">
            ...
            <a
              ...
              href="#"
              title="首页"
              @click.prevent="getTeacherList(1)">首</a>
            <a
              :class="{undisable: !data.hasPrevious}"
              href="#"
              title="前一页"
              @click.prevent="getTeacherList(data.current-1)">&lt;</a>
            <a
              ...
              :title="'第'+page+'页'"
              href="#"
              @click.prevent="getTeacherList(page)">{{ page }}</a>
            <a
            ...
            <a
              ...
              href="#"
              title="末页"
              @click.prevent="getTeacherList(data.pages)">末</a>
            <div class="clear"/>
          </div>
        </div>
        <!-- 公共分页 结束 -->
...
export default {
  ...
  methods:{
    ...
    getTeacherList(page = 1){
      ...
      this.page = page
      teacherApi.getTeacher(this.page, this.limit)
        .then(response => {
