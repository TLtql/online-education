  ...
  <div>
    ...
    <!-- <div v-swiper:mySwiper="swiperOption">
        <div class="swiper-wrapper">
            <div v-for="bannerInfo in bannerList" :key="bannerInfo.id" class="swiper-slide" style="background: #040B1B;">
                <a target="_blank" :href="bannerInfo.linkUrl">
                    <img :src="bannerInfo.imageUrl" :alt="bannerInfo.title">
                </a>
            </div>
        </div>
